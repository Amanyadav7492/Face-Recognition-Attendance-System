...
class Student:
    def __init__(self, root):
        ...
        # first image
        img = Image.open(r"/Users/amanyadav/Desktop/Face_Recognition_System/images/img11.jpg")
        ...
        # second image
        img1 = Image.open(r"/Users/amanyadav/Desktop/Face_Recognition_System/images/img12.jpg")
        ...
        # third image
        img2 = Image.open(r"/Users/amanyadav/Desktop/Face_Recognition_System/images/img13.jpg")
        ...
        current_course_frame.place(x=5, y=135, width=720, height=100)
        ...
        sem_combo = ttk.Combobox(current_course_frame,textvariable= self.var_semester, font=("times new roman", 12, "bold"), state="readonly", width=25)
        ...
        save_btn = Button(btn_frame, text="Save",command=self.add_data, width=20, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        save_btn.grid(row=0, column=0)

        update_btn = Button(btn_frame, text="Update",command=self.update_data, width=20, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Delete",command=self.delete_data, width=20, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Reset",command=self.reset_data, width=20, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        ...
        take_photo_btn = Button(btn_frame1,command=self.generate_dataset, text="Take Photo Sample", width=45, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn = Button(btn_frame1, text="Update Photo Sample", width=45, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        ...
        img_right = Image.open(r"/Users/amanyadav/Desktop/Face_Recognition_System/images/img15.jpg")
        ...
        search_btn = Button(Search_frame, text="Search", width=12, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        search_btn.grid(row=0, column=3, padx=4)

        showAll_btn = Button(Search_frame, text="Show All", width=12, font=("times new roman", 13, "bold"), bg="darkblue", fg="black")
        ...
        # Call the fetch_data function to load data on startup
        self.fetch_data()
            ...
            try:
                ...
                with open("student_data.csv", mode='a', newline='') as file:
                    ...
                    if not file_exists:
                        ...
                        writer.writerow(["Department", "Course", "Year", "Semester", "Student ID", "Name", "Division", "Roll No", "Gender", "D.O.B", "Email", "Phone", "Address", "Teacher", "Photo Sample Status"])
    ...
    def fetch_data(self):
        """
        Fetches all data from the CSV file and displays it in the Treeview table.
        """
        if not os.path.isfile("student_data.csv"):
    ...
    def update_data(self):
        ...
        for i, row in enumerate(rows):
            if row[4] == self.var_std_id.get():   # Match Student ID
                rows[i] = [
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def delete_data(self):
        ...
        option = messagebox.askyesno("Delete", "Are you sure you want to delete this record?", parent=self.root)
        if option == 0:
            return
        ...
        rows = [row for row in rows if row[4] != self.var_std_id.get()]
    ...
    def generate_dataset(self):
        ...
        # Load Haar cascade classifier for face detection from opencv
        ...
        # kyunki web camera open karne ka 0 hota hai other camera open karne ka 1 hota hai
        ...
        while True:
            ...
            if face_cropped(frame) is not None:
                ...
                # Save file as student.id.sampleNo.jpg
            ...
            if cv2.waitKey(1) == 13 or int(img_id) == 100:  # Press Enter or stop at 100 samples
                break

        cap.release()
        cv2.destroyAllWindows()

        messagebox.showinfo("Result", f"Generating data sets completed!!!: {self.var_std_id.get()}", parent=self.root)
